...
public class Payment extends javax.swing.JFrame {
    ...
    Payment(List<ListProduct> list, double total) {
        initComponents();
        this.list=list;
        this.total=total;
    ...
    public Collection data(){
        ...
        for(ListProduct temp:list){
            ...
            ListProduct pro=new ListProduct(id, name, qty, price);
            ls.add(pro);
        }
        return ls;
    }
    ...
    private void cbDisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbDisActionPerformed
        float dis=0.0f;
        int op=this.cbDis.getSelectedIndex();
        switch (op) {
            case 0:
                dis=0.0f;
                break;
        ...
        this.txtPay.setText(String.valueOf(df.format(this.total)));
